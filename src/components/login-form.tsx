...
export function LoginForm({
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <AnimatedGradientText className="font-medium">
                            <h1 className="text-4xl font-bold ">Sign in</h1>                                    </AnimatedGradientText>
            ...
            <div className="text-center text-sm "> Don&apos;t have an account?{" "} <a href="/signup" className="underline underline-offset-4"> Sign up </a> </div>
