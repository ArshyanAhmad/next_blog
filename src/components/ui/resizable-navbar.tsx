            ...
            {items.map((item, idx) => (
                ...
                >
                    {hovered === idx && (
                        ...
                        >
                            <div className="absolute inset-x-0 top-0 mx-auto h-px w-1/2 bg-gradient-to-r from-transparent via-teal-500 to-transparent" />
                        </motion.div>
                    )}
...
type NavbarButtonProps = NavbarButtonBaseProps &
